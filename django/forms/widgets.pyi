...
class ChoiceInput(SubWidget):
    ...
    def render(self, name: Optional[Any] = ..., value: Optional[Any] = ..., attrs: Optional[Any] = ...): ...
    def is_checked(self): ...
...
class RendererMixin:
    renderer = ...  # type: Any
    def __init__(self, *args, **kwargs) -> None: ...
    def subwidgets(self, name, value, attrs: Optional[Any] = ...): ...
    def get_renderer(self, name, value, attrs: Optional[Any] = ...): ...
    def render(self, name, value, attrs: Optional[Any] = ...): ...
    def id_for_label(self, id_): ...
