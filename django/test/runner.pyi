...
class DiscoverRunner:
    ...
    def __init__(self, pattern: Optional[Any] = ..., top_level: Optional[Any] = ..., verbosity: int = ..., interactive: bool = ..., failfast: bool = ..., keepdb: bool = ..., reverse: bool = ..., debug_sql: bool = ..., parallel: int = ..., tags: Optional[Any] = ..., exclude_tags: Optional[Any] = ..., **kwargs) -> None: ...
    @classmethod
