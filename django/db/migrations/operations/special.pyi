...
class RunSQL(Operation):
    ...
    hints = ...  # type: Any
    elidable = ...  # type: Any
    def __init__(self, sql, reverse_sql: Optional[Any] = ..., state_operations: Optional[Any] = ..., hints: Optional[Any] = ..., elidable: bool = ...) -> None: ...
    def deconstruct(self): ...
    @property
    def reversible(self): ...
    def state_forwards(self, app_label, state): ...
...
class RunPython(Operation):
    ...
    hints = ...  # type: Any
    elidable = ...  # type: Any
    def __init__(self, code, reverse_code: Optional[Any] = ..., atomic: Optional[Any] = ..., hints: Optional[Any] = ..., elidable: bool = ...) -> None: ...
    def deconstruct(self): ...
    @property
    def reversible(self): ...
    def state_forwards(self, app_label, state): ...
