...
class RequestContext(Context):
    request = ...  # type: Any
    def __init__(self, request, dict_: Optional[Any] = ..., processors: Optional[Any] = ..., use_l10n: Optional[Any] = ..., use_tz: Optional[Any] = ..., autoescape: bool = ...) -> None: ...
    template = ...  # type: Any
    def bind_template(self, template): ...
    def new(self, values: Optional[Any] = ...): ...

def make_context(context, request: Optional[Any] = ..., **kwargs): ...
